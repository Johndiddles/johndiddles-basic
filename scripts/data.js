export const projects = [
  ...
  },
  {
    ...
    codeBaseUrl: null,
    description:
      "RagauNG seamlessly connects you with verified professionals for any need. RagauNG simplifies life, putting a curated network of skilled service providers and more at your fingertips. Book appointments, compare quotes, and enjoy reliable service – all stress-free, all online. Built with Astro Js",
  },
  {
    ...
    codeBaseUrl: null,
    description:
      "Middlechase Properties empowers Nigerians to own and manage income-generating apartments and lands for both residential and commercial use. They specialize in high-cash-flow properties and offer comprehensive property management, making real estate investment in Nigeria simple and profitable. Built with React Js, Redux, Node Js, Express Js, MySQL and AWS",
  },
